...
- [x] Upload an architecture diagram showing the public sandbox, private runtime boundary, Gemma privacy guard, ADK/Gemini, Cloud Run, Firestore and asynchronous services.
...
- [x] Add the hosted public-sandbox URL after deployment is verified; never submit the private Sydney v2 URL as the product entry.
...
- [x] Include: **“This content was created for the purposes of entering the All Things Agentic Hackathon.”**
...
- [x] Public sandbox URL and fresh-browser smoke test.
- [x] Passing Python, React/TypeScript, Terraform and Trivy CI links.
- [x] Successful Terraform deployment evidence.
- [x] Architecture diagram, public demo video, technical article and social-post URLs.
- [x] Gemma implementation and test evidence.
- [x] Final Devpost preview checked before submission.
